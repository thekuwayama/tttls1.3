...
| `:supported_groups` | Array of TTTLS13::NamedGroup constant | `X25519`, `X448`, `SECP256R1`, `SECP384R1`, `SECP521R1` | List of named groups offered in ClientHello extensions. |
...
| `:supported_groups` | Array of TTTLS13::NamedGroup constant | `X25519`, `X448`, `SECP256R1`, `SECP384R1`, `SECP521R1` | List of supported named groups. |
